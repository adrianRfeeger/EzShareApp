# Form implementation generated from reading ui file 'EzShareCPAP.ui'
#
...
class Ui_EzShareCPAP(object):
    def setupUi(self, EzShareCPAP):
        ...
        self.pathEntry.setBaseSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        ...
        self.urlEntry.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Andale Mono")
        font.setPointSize(14)
        ...
        self.importOscarCheckbox.setBaseSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Geneva")
        font.setPointSize(14)
